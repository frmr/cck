...
namespace cck
{
	...
	private:
		...
		public:
			...
			void						SampleData( double& sampleHeight, int& sampleId ) const;
		...
		public:
			...
			bool						SampleData( const cck::GeoCoord& sampleCoord, const cck::Vec3& samplePoint, const double globeRadius, double& sampleHeight, int& sampleId ) const;
