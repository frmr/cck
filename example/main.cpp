...
//	globe.LinkNodes( 4, 3,	10.0,	400.0,	100.0 );
	...
	globe.AddNode( 1,	46.0,	2.0,	-0.3,	0.5,	600.0 );	//France
	globe.AddNode( 2,	40.0,	-4.0,	-0.3,	1.0,	750.0 );	//Iberia
	...
	globe.AddNode( 8,	57.0,	44.0,	-0.5,	0.75,	1200.0 );	//Russia
	...
	globe.AddNode( 13,	65.0,	75.0,	-0.25,	0.5,	1300.0 );	//Siberia 1
	globe.AddNode( 14,	65.0,	106.0,	-0.5,	0.75,	1400.0 );	//Siberia 2
	globe.AddNode( 15,	32.0,	88.0,	1.0,	4.0,	500.0 );	//Himalayas
	globe.AddNode( 16,	25.0,	80.0,	-0.5,	1.0,	1000.0 );	//North India
	...
	globe.AddNode( 27,	62.0,	165.0,	-0.5,	2.0,	1000.0 );	//Siberia 4
